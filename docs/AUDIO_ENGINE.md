...
- **Snare**: Pink noise burst passed through a bandpass filter centered at 750Hz (Q: 0.8) for a dusty, soft thwack.
- **Hi-hat**: Pink noise burst (softer and less tiring than white noise) passed through a highpass filter centered at 6500Hz.

### 5. Ambience

- **Ocean Waves**: Synced LFOs (0.05Hz) modulate both the volume (0.05 to 0.7) and the lowpass filter cutoff frequency (220Hz to 680Hz) to simulate bright wave crests and dark retreats.
